...
// FIX: Changed the forwarded ref's element type to an intersection of HTMLButtonElement and HTMLAnchorElement.
// This allows the ref to be compatible with both element types that the component can render.
